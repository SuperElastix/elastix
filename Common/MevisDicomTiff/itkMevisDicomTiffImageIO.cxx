...
// findelement
bool
MevisDicomTiffImageIO::FindElement(const gdcm::DataSet ds,
                                   const gdcm::Tag     tag,
                                   gdcm::DataElement & de,
...
MevisDicomTiffImageIO::CanReadFile(const char * filename)
{
  ...
  // extension!
  if (ext != ".dcm" && ext != ".DCM" && ext != ".tif" && ext != ".TIF" && ext != ".tiff" && ext != ".TIFF")
  {
    return false;
  }
...
// write
void
MevisDicomTiffImageIO ::Write(const void * buffer)
{

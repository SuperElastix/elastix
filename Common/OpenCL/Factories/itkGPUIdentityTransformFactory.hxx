...
{
  using GPUTransformFactoryType = GPUIdentityTransformFactory2<NDimensions>;
...
template <typename NDimensions>
void
GPUIdentityTransformFactory2<NDimensions>::Register1D()
{
...
template <typename NDimensions>
void
GPUIdentityTransformFactory2<NDimensions>::Register2D()
{
  // Define visitor and perform factory registration
...
template <typename NDimensions>
void
GPUIdentityTransformFactory2<NDimensions>::Register3D()
{
  // Define visitor and perform factory registration

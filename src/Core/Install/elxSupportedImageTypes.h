...
namespace elastix
{
	...
	const unsigned int NrOfSupportedImageTypes = 2;
...
//	elxSupportedImageTypeMacro( float,						2, float,							2,	7 );
//	elxSupportedImageTypeMacro( float,						3, float,							3,	8 );
...
//	elxSupportedImageTypeMacro( unsigned char,		2, unsigned char,			2,	13 );
//	elxSupportedImageTypeMacro( unsigned char,		3, unsigned char,			3,	14 );

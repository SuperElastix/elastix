...
// Testing GPU Rescale Image Filter with AffineTransform

// Interpolator NearestNeighbor:
// 1D:
// -in D:\\work\\elastix-ext\\ITK4OpenCL\\data\\image-512-1D.mha -out D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test8\\image-512-1D-out-cpu.mha D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test8\\image-512-1D-out-gpu.mha -gpu -rsm 1.5
// 2D:
// -in D:\\work\\elastix-ext\\ITK4OpenCL\\data\\image-256x256-2D.mha -out D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test8\\image-256x256-2D-out-cpu.mha D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test8\\image-256x256-2D-out-gpu.mha -gpu -rsm 6.0
// 3D:
// -in D:\\work\\elastix-ext\\ITK4OpenCL\\data\\image-256x256x256-3D.mha -out D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test8\\image-256x256x256-3D-out-cpu.mha D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test8\\image-256x256x256-3D-out-gpu.mha -gpu -rsm 0.0

// Interpolator Linear:
// 1D: 
// -in D:\\work\\elastix-ext\\ITK4OpenCL\\data\\image-512-1D.mha -out D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test9\\image-512-1D-out-cpu.mha D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test9\\image-512-1D-out-gpu.mha -i Linear -gpu -rsm 0.4
// 2D:
// -in D:\\work\\elastix-ext\\ITK4OpenCL\\data\\image-256x256-2D.mha -out D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test9\\image-256x256-2D-out-cpu.mha D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test9\\image-256x256-2D-out-gpu.mha -i Linear -gpu -rsm 0.3
// 3D:
// -in D:\\work\\elastix-ext\\ITK4OpenCL\\data\\image-256x256x256-3D.mha -out D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test9\\image-256x256x256-3D-out-cpu.mha D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test9\\image-256x256x256-3D-out-gpu.mha -i Linear -gpu -rsm 0.2

// Interpolator BSpline:
// 1D:
// -in D:\\work\\elastix-ext\\ITK4OpenCL\\data\\image-512-1D.mha -out D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test10\\image-512-1D-out-cpu.mha D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test10\\image-512-1D-out-gpu.mha -i BSpline -gpu -rsm 0.25
// 2D:
// -in D:\\work\\elastix-ext\\ITK4OpenCL\\data\\image-256x256-2D.mha -out D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test10\\image-256x256-2D-out-cpu.mha D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test10\\image-256x256-2D-out-gpu.mha -i BSpline -gpu -rsm 0.2
// 3D:
// -in D:\\work\\elastix-ext\\ITK4OpenCL\\data\\image-256x256x256-3D.mha -out D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test10\\image-256x256x256-3D-out-cpu.mha D:\\work\\elastix-ext\\ITK4OpenCL\\data\\test10\\image-256x256x256-3D-out-gpu.mha -i BSpline -gpu -rsm 0.3
...
int ProcessImage(const Parameters &_parameters)
{
  ...
  typedef itk::AffineTransform<float, ImageDim>                            CPUTransformType;
  ...
  typedef itk::AffineTransform<float, ImageDim>                            GPUTransformType;
  ...
  typename CPUTransformType::ParametersType parameters(ImageDim*ImageDim + ImageDim);
  ...
  if(!_parameters.skipCPU)
  {
    for(unsigned int i=0; i<_parameters.runTimes; i++)
    {
      ...
      CPUFilter->SetDefaultPixelValue( -1 );
      CPUFilter->SetOutputSpacing( spacing );
  ...
  if(!_parameters.skipGPU)
  {
    for(unsigned int i=0; i<_parameters.runTimes; i++)
    {
      ...
      GPUFilter->SetDefaultPixelValue( -1 );
      GPUFilter->SetOutputSpacing( spacing );

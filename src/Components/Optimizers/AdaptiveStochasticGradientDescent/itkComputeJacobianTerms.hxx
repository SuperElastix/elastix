...
void
ComputeJacobianTerms< TFixedImage, TTransform >
::ComputeParameters( double & TrC, double & TrCC, double & maxJJ, double & maxJCJ )
{
        ...
        ImageSampleContainerPointer & sampleContainer )
{
    ...
    /** Set up grid sampler. */
    this->m_UseRandomSamplerForJacobianMeasurements = false;
//    if(this->m_UseRandomSamplerForJacobianMeasurements)
//    {
//        //ImageRandomSamplerPointer sampler = ImageRandomSamplerType::New();

...
#ifndef __elxBSplineInterpolatorFast_h
#define __elxBSplineInterpolatorFast_h
...
{
  /**
   * \class BSplineInterpolatorFast
   * \brief An interpolator based on the itkBSplineInterpolateImageFunctionWykeBase.
   *
   ...
   *    <tt>(Interpolator "BSplineInterpolatorFast")</tt>
  ...
  template < class TElastix >
    class BSplineInterpolatorFast :
    public
      itk::BSplineInterpolateImageFunctionWykeBase<
  ...
  public:
    ...
    /** Standard ITK-stuff. */
    typedef BSplineInterpolatorFast  Self;
    typedef itk::BSplineInterpolateImageFunctionWykeBase<
      typename InterpolatorBase<TElastix>::InputImageType,
      typename InterpolatorBase<TElastix>::CoordRepType,
      double >                                  Superclass1;
    ...
    itkTypeMacro( BSplineInterpolatorFast, BSplineInterpolateImageFunctionWykeBase );
  ...
  protected:
    ...
    /** The constructor. */
    BSplineInterpolatorFast() {}
    /** The destructor. */
    virtual ~BSplineInterpolatorFast() {}

  private:

    /** The private constructor. */
    BSplineInterpolatorFast( const Self& ); // purposely not implemented
    /** The private copy constructor. */
    void operator=( const Self& );      // purposely not implemented

  }; // end class BSplineInterpolatorFast

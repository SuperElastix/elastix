...
======================================================================*/
#ifndef __elxRecursiveBSplineStackTransform_hxx
#define __elxRecursiveBSplineStackTransform_hxx

#include "elxRecursiveBSplineStackTransform.h"
...
RecursiveBSplineStackTransform< TElastix >
::RecursiveBSplineStackTransform()
{} // end Constructor()
...
::InitializeBSplineTransform()
{
  ...
  if( m_SplineOrder == 1 )
  {
    this->m_RecursiveBSplineDummySubTransform = RecursiveBSplineTransformLinearType::New();
  }
  else if( m_SplineOrder == 2 )
  {
    this->m_RecursiveBSplineDummySubTransform = RecursiveBSplineTransformQuadraticType::New();
  }
  else if( m_SplineOrder == 3 )
  {
    this->m_RecursiveBSplineDummySubTransform = RecursiveBSplineTransformCubicType::New();
  }
  else
  {
  ...
  this->m_RecursiveBSplineStackTransform = RecursiveBSplineStackTransformType::New();

  /** Set stack transform as current transform. */
  this->SetCurrentTransform( this->m_RecursiveBSplineStackTransform );
...
::BeforeRegistration( void )
{
  ...
  this->m_RecursiveBSplineDummySubTransform->SetGridRegion( gridregion );
  this->m_RecursiveBSplineDummySubTransform->SetGridSpacing( gridspacing );
  this->m_RecursiveBSplineDummySubTransform->SetGridOrigin( gridorigin );
  ...
  this->m_RecursiveBSplineStackTransform->SetStackOrigin( this->m_StackOrigin );
  this->m_RecursiveBSplineStackTransform->SetStackSpacing( this->m_StackSpacing );

  /** Initialize stack sub transforms. */
  this->m_RecursiveBSplineStackTransform->SetAllSubTransforms( this->m_RecursiveBSplineDummySubTransform );
...
::InitializeTransform( void )
{
  ...
  this->m_RecursiveBSplineDummySubTransform->SetGridSpacing( gridSpacing );
  this->m_RecursiveBSplineDummySubTransform->SetGridOrigin( gridOrigin );
  this->m_RecursiveBSplineDummySubTransform->SetGridDirection( gridDirection );
...
::IncreaseScale( void )
{
  ...
  ReducedDimensionRecursiveBSplineTransformBasePointer firstsubtransform
    = dynamic_cast< ReducedDimensionRecursiveBSplineTransformBaseType * >(
    this->m_RecursiveBSplineStackTransform->GetSubTransform( 0 ).GetPointer() );
  ...
  for( unsigned int t = 0; t < this->m_NumberOfSubTransforms; ++t )
  {
    ...
    ReducedDimensionRecursiveBSplineTransformBasePointer subtransform
      = dynamic_cast< ReducedDimensionRecursiveBSplineTransformBaseType * >( this->m_RecursiveBSplineStackTransform->GetSubTransform( t ).GetPointer() );
...
::WriteToFile( const ParametersType & param ) const
{
  ...
  ReducedDimensionRecursiveBSplineTransformBasePointer firstSubTransform
    = dynamic_cast< ReducedDimensionRecursiveBSplineTransformBaseType * >( this->m_RecursiveBSplineStackTransform->GetSubTransform( 0 ).GetPointer() );
  ...
  xout[ "transpar" ] << "(StackSpacing " << this->m_RecursiveBSplineStackTransform->GetStackSpacing() << ")" << std::endl;
  xout[ "transpar" ] << "(StackOrigin " << this->m_RecursiveBSplineStackTransform->GetStackOrigin() << ")" << std::endl;
  xout[ "transpar" ] << "(NumberOfSubTransforms " << this->m_RecursiveBSplineStackTransform->GetNumberOfSubTransforms() << ")" << std::endl;
...
template< class TElastix >
void
RecursiveBSplineStackTransform< TElastix >::SetOptimizerScales( const unsigned int edgeWidth )
{
  /** Some typedefs. */
  ...
  const NumberOfParametersType numberOfParameters
    = this->m_RecursiveBSplineDummySubTransform->GetNumberOfParameters();
  ...
  RecursiveBSplineTransformBasePointer firstSubTransform
    = dynamic_cast< RecursiveBSplineTransformBaseType * >( this->m_RecursiveBSplineStackTransform->GetSubTransform( 0 ).GetPointer() );

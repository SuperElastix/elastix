...
#ifndef __itkEulerStackTransformInitializer_h
#define __itkEulerStackTransformInitializer_h
...
/**
 * \class EulerStackTransformInitializer
 *
 * \brief EulerStackTransformInitializer is a helper class intended to
...
class TFixedImage,
class TMovingImage >
class EulerStackTransformInitializer : public Object
{
public:

  /** Standard class typedefs. */
  typedef EulerStackTransformInitializer Self;
  ...
  itkTypeMacro( EulerStackTransformInitializer, Object );
  ...
  typedef typename ReducedDimensionTransformType::OutputVectorType ReducedDimensionOutputVectorType;
    typedef typename itk::ContinuousIndex< double, ReducedInputSpaceDimension > ReducedDimensionContinuousIndexType;
    typedef typename itk::ContinuousIndex< double, InputSpaceDimension > ContinuousIndexType;
  ...
  virtual void InitializeTransform(bool centerGivenAsIndex, bool centerGivenAsPoint,ContinuousIndexType centerOfRotationIndex,InputPointType centerOfRotationPoint) const;
...
private:
  ...
  EulerStackTransformInitializer( const Self & ); // purposely not implemented
...
#include "itkEulerStackTransformInitializer.hxx"
#endif

#endif /* __itkEulerStackTransformInitializer_h */

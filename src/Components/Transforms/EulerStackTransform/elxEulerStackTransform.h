 ...
 */
  ...
  typedef typename itk::ContinuousIndex< CoordRepType, SpaceDimension > ContinuousIndexType;
        ...
        /** Extra typedefs */
        typedef itk::EulerStackTransformInitializer<EulerStackTransformType, ReducedDimensionEulerTransformType,
        FixedImageType, MovingImageType >                                   StackTransformInitializerType;
        typedef typename StackTransformInitializerType::Pointer             StackTransformInitializerPointer;

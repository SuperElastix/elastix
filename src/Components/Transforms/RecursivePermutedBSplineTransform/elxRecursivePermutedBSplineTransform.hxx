 ...
 *
 *=========================================================================*/
#ifndef __elxRecursivePermutedBSplineTransform_hxx
#define __elxRecursivePermutedBSplineTransform_hxx

#include "elxRecursivePermutedBSplineTransform.h"
...
RecursivePermutedBSplineTransform< TElastix >
...
::InitializeBSplineTransform( void )
{
  ...
  if( this->m_Cyclic )
  {
    itkExceptionMacro( << "ERROR: Cyclic currently not supported for RecursivePermutedBSplineTransform." );
...
template< class TElastix >
void
RecursivePermutedBSplineTransform< TElastix >::SetOptimizerScales( const unsigned int edgeWidth )
{
  /** Some typedefs. */
...
#endif // end #ifndef __elxRecursivePermutedBSplineTransform_hxx

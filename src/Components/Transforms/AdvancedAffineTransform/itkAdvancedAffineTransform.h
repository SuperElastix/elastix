...
/*=========================================================================
  ...
  Module:    $RCSfile: itkAdvancedAffineTransform.h,v $
  Language:  C++
 ...
 *
 * The AdvancedAffineTransform class determines whether to transform an object
...
: public AdvancedMatrixOffsetTransformBase< TScalarType, NDimensions, NDimensions >
{
public:
  /** Standard typedefs   */
  typedef AdvancedAffineTransform               Self;
  ...
  itkTypeMacro( AdvancedAffineTransform, AdvancedMatrixOffsetTransformBase );
...
protected:
   ...
   *
   * This method constructs a new AdvancedAffineTransform object and
   * initializes the matrix and offset parts of the transformation
   * to values specified by the caller.  If the arguments are
   * omitted, then the AdvancedAffineTransform is initialized to an identity
   * transformation in the appropriate number of dimensions.   **/
  AdvancedAffineTransform(const MatrixType &matrix,
                  const OutputVectorType &offset);
  AdvancedAffineTransform(unsigned int outputDims,
                  unsigned int paramDims);
  AdvancedAffineTransform();
  
  /** Destroy an AdvancedAffineTransform object   **/
  virtual ~AdvancedAffineTransform();

  /** Print contents of an AdvancedAffineTransform */
...
inline
typename AdvancedAffineTransform<TScalarType, NDimensions>::InputVectorType
...
template<class TScalarType, unsigned int NDimensions>
inline
typename AdvancedAffineTransform<TScalarType, NDimensions>::InputVnlVectorType
AdvancedAffineTransform<TScalarType, NDimensions>::
...
template<class TScalarType, unsigned int NDimensions>
inline
typename AdvancedAffineTransform<TScalarType, NDimensions>::InputCovariantVectorType
AdvancedAffineTransform<TScalarType, NDimensions>::
...
template<class TScalarType, unsigned int NDimensions>
inline
typename AdvancedAffineTransform<TScalarType, NDimensions>::InputPointType
AdvancedAffineTransform<TScalarType, NDimensions>::
...
#define ITK_TEMPLATE_AdvancedAffineTransform(_, EXPORT, x, y) namespace itk { \
  _(2(class EXPORT AdvancedAffineTransform< ITK_TEMPLATE_2 x >)) \
  namespace Templates { typedef AdvancedAffineTransform< ITK_TEMPLATE_2 x > \
                                                  AdvancedAffineTransform##y; } \
  }

#if ITK_TEMPLATE_EXPLICIT
# include "Templates/itkAdvancedAffineTransform+-.h"
#endif

#if ITK_TEMPLATE_TXX
# include "itkAdvancedAffineTransform.txx"
#endif

#endif /* __itkAdvancedAffineTransform_h */

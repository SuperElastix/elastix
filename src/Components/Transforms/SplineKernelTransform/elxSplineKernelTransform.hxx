...
namespace elastix
{
  ...
  template <class TElastix>
    bool SplineKernelTransform<TElastix>
  ...
  template <class TElastix>
    int SplineKernelTransform<TElastix>
    ::BeforeAll(void)
  {
  ...
  template <class TElastix>
    void SplineKernelTransform<TElastix>
    ...
    ::DetermineSourceLandmarks( void )
  {
    ...
    elxout 
      << "Loading fixed image landmarks for " << this->GetComponentLabel()

...
using namespace itk;
   ...
   *    <tt>(MovingImagePyramid "MovingImageShrinkingPyramid")</tt>
   *
  ...
  public:
     ...
     * example: <tt>(MovingImagePyramid "MovingImageShrinkingPyramid")</tt>\n
     */
    elxClassNameMacro( "MovingShrinkingPyramid" );

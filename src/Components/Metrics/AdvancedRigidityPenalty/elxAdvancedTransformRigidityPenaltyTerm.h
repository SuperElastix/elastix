...
======================================================================*/
#ifndef __elxAdvancedTransformRigidityPenaltyTerm_H__
#define __elxAdvancedTransformRigidityPenaltyTerm_H__
...
using namespace itk;
  ...
  /**
   * \class AdvancedTransformRigidityPenalty
   * \brief A penalty term based on the rigidity, orthonormality of the rotation matrix.
   *
   * The parameters used in this class are:
   * \parameter Metric: Select this metric as follows:\n
   *    <tt>(Metric "AdvancedTransformRigidityPenalty")</tt>
   *
   * \ingroup Metrics
   *
   */
...
public:
  ...
  /** Standard ITK-stuff. */
  typedef AdvancedTransformRigidityPenalty              Self;
  typedef AdvancedTransformRigidityPenaltyTerm<
  ...
  itkTypeMacro( AdvancedTransformRigidityPenalty, AdvancedTransformRigidityPenaltyTerm );

  /** Name of this class.
   * Use this name in the parameter file to select this specific metric. \n
   * example: <tt>(Metric "AdvancedTransformRigidityPenalty")</tt>\n
   */
  elxClassNameMacro( "AdvancedTransformRigidityPenalty" );
...
protected:
  ...
  /** The constructor. */
  AdvancedTransformRigidityPenalty(){};

  /** The destructor. */
  virtual ~AdvancedTransformRigidityPenalty() {}

private:

  /** The private constructor. */
  AdvancedTransformRigidityPenalty( const Self& ); // purposely not implemented
  /** The private copy constructor. */
  void operator=( const Self& );              // purposely not implemented

}; // end class AdvancedTransformRigidityPenalty
...
#include "elxAdvancedTransformRigidityPenaltyTerm.hxx"
#endif

#endif // end #ifndef __elxAdvancedTransformRigidityPenaltyTerm_H__

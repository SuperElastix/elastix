#ifndef __elxProbabilityAverageMutualInformationMetric_H__
#define __elxProbabilityAverageMutualInformationMetric_H__
...
namespace elastix
{
    ...
    class ProbabilityAverageMutualInformationMetric : public itk::ProbabilityAverageMutualInformationMetric< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef ProbabilityAverageMutualInformationMetric                                                                                                            Self;
            typedef itk::ProbabilityAverageMutualInformationMetric< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( ProbabilityAverageMutualInformationMetric, itk::ProbabilityAverageMutualInformationMetric );
        
            elxClassNameMacro( "ProbabilityAverageMutualInformationMetric" );
...
#include "elxProbabilityAverageMutualInformationMetric.hxx"
#endif

#endif // end #ifndef __elxProbabilityAverageMutualInformationMetric_H__

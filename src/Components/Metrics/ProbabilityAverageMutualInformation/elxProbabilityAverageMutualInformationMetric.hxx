#ifndef __elxProbabilityAverageMutualInformationMetric_HXX__
#define __elxProbabilityAverageMutualInformationMetric_HXX__
...
namespace elastix
{
    ...
    ProbabilityAverageMutualInformationMetric< TElastix >
...
//        timer->StopTimer();
//        elxout << "Initialization of ProbabilityAverageMutualInformationMetric metric took: " << static_cast< long >( timer->GetElapsedClockSec() * 1000 ) << " ms." << std::endl;
...
#endif // end #ifndef _elxProbabilityAverageMutualInformationMetric_HXX__

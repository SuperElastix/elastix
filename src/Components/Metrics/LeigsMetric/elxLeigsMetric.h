#ifndef __elxLeigsMetric_H__
#define __elxLeigsMetric_H__
...
namespace elastix
{
    ...
    class LeigsMetric : public itk::LeigsMetric< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef LeigsMetric      Self;
            typedef itk::LeigsMetric< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( LeigsMetric, itk::LeigsMetric );
        
            elxClassNameMacro( "LeigsMetric" );
...
#include "elxLeigsMetric.hxx"
#endif

#endif // end #ifndef __elxLeigsMetric_H__

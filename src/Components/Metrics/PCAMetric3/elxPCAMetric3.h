 ...
 *
 *=========================================================================*/
#ifndef __elxPCAMetric3_H__
#define __elxPCAMetric3_H__
...
namespace elastix
{
  ...
  public:
    ...
    /** Standard ITK-stuff. */
    typedef PCAMetric3              Self;
    typedef itk::PCAMetric3<
      typename MetricBase<TElastix>::FixedImageType,
    ...
    itkTypeMacro( PCAMetric3, itk::PCAMetric3 );

    /** Name of this class.
     * Use this name in the parameter file to select this specific metric. \n
     * example: <tt>(Metric "PCAMetric3")</tt>\n
     */
    elxClassNameMacro( "PCAMetric3" );
  ...
  private:
    ...
    PCAMetric3( const Self& ); // purposely not implemented
    /** The private copy constructor. */
    void operator=( const Self& );              // purposely not implemented

  }; // end class PCAMetric3
...
#include "elxPCAMetric3.hxx"
#endif

#endif // end #ifndef __elxPCAMetric3_H__

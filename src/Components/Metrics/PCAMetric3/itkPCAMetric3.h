...
#ifndef __itkPCAMetric3_h
#define __itkPCAMetric3_h
...
public:
    ...
    itkTypeMacro( PCAMetric3, AdvancedImageToImageMetric );
...
#include "itkPCAMetric3.hxx"
#endif

#endif // end #ifndef __itkPCAMetric3_h

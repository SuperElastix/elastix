#ifndef __itkLinearGroupwiseJE_H__
#define __itkLinearGroupwiseJE_H__
...
namespace itk
{
    ...
    class LinearGroupwiseJE : public LinearScalingGroupwiseMetric< TFixedImage, TMovingImage >
    {
    public:
        
        typedef LinearGroupwiseJE                          Self;
        ...
        itkTypeMacro( LinearGroupwiseJE, LinearScalingGroupwiseMetric );
    ...
    protected:
        ...
        struct LinearGroupwiseJEMultiThreaderParameterType
        {
            Self * m_Metric;
        };
        
        LinearGroupwiseJEMultiThreaderParameterType m_LinearGroupwiseJEThreaderParameters;
        
        struct LinearGroupwiseJEGetValueAndDerivativePerThreadStruct
        {
        ...
        itkPadStruct( ITK_CACHE_LINE_ALIGNMENT, LinearGroupwiseJEGetValueAndDerivativePerThreadStruct, PaddedLinearGroupwiseJEGetValueAndDerivativePerThreadStruct );
        itkAlignedTypedef( ITK_CACHE_LINE_ALIGNMENT, PaddedLinearGroupwiseJEGetValueAndDerivativePerThreadStruct, AlignedLinearGroupwiseJEGetValueAndDerivativePerThreadStruct );
        
        mutable AlignedLinearGroupwiseJEGetValueAndDerivativePerThreadStruct *  m_LinearGroupwiseJEGetValueAndDerivativePerThreadVariables;
        mutable ThreadIdType                                                                    m_LinearGroupwiseJEGetValueAndDerivativePerThreadVariablesSize;
    ...
    private:
        ...
        LinearGroupwiseJE( const Self & ); // purposely not implemented
...
#include "itkLinearGroupwiseJE.hxx"
#endif

#endif // end #ifndef __itkLinearGroupwiseJE_H__

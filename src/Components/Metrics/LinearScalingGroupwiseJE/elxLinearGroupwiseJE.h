#ifndef __elxLinearGroupwiseJE_H__
#define __elxLinearGroupwiseJE_H__
...
namespace elastix
{
    ...
    class LinearGroupwiseJE : public itk::LinearGroupwiseJE< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef LinearGroupwiseJE      Self;
            typedef itk::LinearGroupwiseJE< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( LinearGroupwiseJE, itk::LinearGroupwiseJE );
        
            elxClassNameMacro( "LinearGroupwiseJE" );
...
#include "elxLinearGroupwiseJE.hxx"
#endif

#endif // end #ifndef __elxLinearGroupwiseJE_H__

...
Module:    $RCSfile: itkGradientDifferenceImageToImageMetric2.txx,v $
Language:  C++
...
::GetValue( const TransformParametersType & parameters ) const
{
  ...
  // subtractionFactor should be optimized seperately within
	// each iteration. However, here we keep it fixed

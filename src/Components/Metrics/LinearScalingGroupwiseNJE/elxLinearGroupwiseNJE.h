#ifndef __elxLinearGroupwiseNJE_H__
#define __elxLinearGroupwiseNJE_H__
...
namespace elastix
{
    ...
    class LinearGroupwiseNJE : public itk::LinearGroupwiseNJE< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef LinearGroupwiseNJE      Self;
            typedef itk::LinearGroupwiseNJE< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( LinearGroupwiseNJE, itk::LinearGroupwiseNJE );
        
            elxClassNameMacro( "LinearGroupwiseNJE" );
...
#include "elxLinearGroupwiseNJE.hxx"
#endif

#endif // end #ifndef __elxLinearGroupwiseNJE_H__

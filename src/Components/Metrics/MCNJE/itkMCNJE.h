#ifndef __itkMCNJE_H__
#define __itkMCNJE_H__
...
namespace itk
{
    ...
    class MCNJE : public LinearScalingMCMetric< TFixedImage, TMovingImage >
    {
    public:
        
        typedef MCNJE                          Self;
        typedef LinearScalingMCMetric< TFixedImage, TMovingImage > Superclass;
        typedef SmartPointer< Self >                                    Pointer;
        typedef SmartPointer< const Self >                              ConstPointer;
        
        itkNewMacro( Self) ;
        
        itkTypeMacro( MCNJE, LinearScalingMCMetric );
        ...
        using LinearScalingMCMetric< TFixedImage, TMovingImage >::GetValueAndDerivative;
        using LinearScalingMCMetric< TFixedImage, TMovingImage >::GetValue;
    ...
    protected:
        ...
        struct MCNJEMultiThreaderParameterType
        {
            Self * m_Metric;
        };
        
        MCNJEMultiThreaderParameterType m_MCNJEThreaderParameters;
        
        struct MCNJEGetValueAndDerivativePerThreadStruct
        {
        ...
        itkPadStruct( ITK_CACHE_LINE_ALIGNMENT, MCNJEGetValueAndDerivativePerThreadStruct, PaddedMCNJEGetValueAndDerivativePerThreadStruct );
        itkAlignedTypedef( ITK_CACHE_LINE_ALIGNMENT, PaddedMCNJEGetValueAndDerivativePerThreadStruct, AlignedMCNJEGetValueAndDerivativePerThreadStruct );
        
        mutable AlignedMCNJEGetValueAndDerivativePerThreadStruct *  m_MCNJEGetValueAndDerivativePerThreadVariables;
        mutable ThreadIdType                                                                    m_MCNJEGetValueAndDerivativePerThreadVariablesSize;
    ...
    private:
        ...
        MCNJE( const Self & ); // purposely not implemented
...
#include "itkMCNJE.hxx"
#endif

#endif // end #ifndef __itkMCNJE_H__

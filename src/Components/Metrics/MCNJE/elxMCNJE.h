#ifndef __elxMCNJE_H__
#define __elxMCNJE_H__
...
namespace elastix
{
    ...
    class MCNJE : public itk::MCNJE< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef MCNJE      Self;
            typedef itk::MCNJE< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( MCNJE, itk::MCNJE );
        
            elxClassNameMacro( "MCNJE" );
...
#include "elxMCNJE.hxx"
#endif

#endif // end #ifndef __elxMCNJE_H__

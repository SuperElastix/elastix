#ifndef _itkMCNJE_HXX__
#define _itkMCNJE_HXX__
...
namespace itk
{
    ...
    MCNJE< TFixedImage, TMovingImage >
    ::MCNJE()
    {
        this->m_UseDerivative = true;
        this->SetUseImageSampler( true );
        
        this->m_MCNJEThreaderParameters.m_Metric = this;
        
        this->m_MCNJEGetValueAndDerivativePerThreadVariables     = NULL;
        this->m_MCNJEGetValueAndDerivativePerThreadVariablesSize = 0;
    ...
    ::~MCNJE()
    {
        delete[] this->m_MCNJEGetValueAndDerivativePerThreadVariables;
    ...
    ::ComputePDFsThreaderCallback( void * arg )
    {
        ...
        MCNJEMultiThreaderParameterType * temp
        = static_cast< MCNJEMultiThreaderParameterType * >( infoStruct->UserData );
    ...
    ::LaunchComputePDFsThreaderCallback( void ) const
    {
        ...
        local_threader->SetSingleMethod( this->ComputePDFsThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_MCNJEThreaderParameters ) ) );
    ...
    ::InitializeThreadingParameters( void ) const
    {
        ...
        if( this->m_MCNJEGetValueAndDerivativePerThreadVariablesSize != this->m_NumberOfThreads )
        {
            delete[] this->m_MCNJEGetValueAndDerivativePerThreadVariables;
            this->m_MCNJEGetValueAndDerivativePerThreadVariables = new AlignedMCNJEGetValueAndDerivativePerThreadStruct[this->m_NumberOfThreads ];
            this->m_MCNJEGetValueAndDerivativePerThreadVariablesSize = this->m_NumberOfThreads;
        }
        
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted = NumericTraits< SizeValueType >::Zero;
            this->m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector.assign(lastDimSize, NumericTraits< SizeValueType >::Zero);
            this->m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs.resize(lastDimSize);
            this->m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_Derivatives.resize(lastDimSize);

            for(unsigned int d = 0; d < lastDimSize; d++)
            {
                JointPDFPointer & jointPDF = this->m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[ d ];
                ...
                if (this->m_UseExplicitPDFDerivatives)
                {
                    this->m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_Derivatives.clear();
                }
    ...
    ::AfterThreadedComputePDFs( void ) const
    {
        ...
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_NumberOfPixelsCounted += this->m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted;

            for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
            {
                this->m_NumberOfPixelsCountedVector[this->m_RandomList[s]] += this->m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector[this->m_RandomList[s]];
            }
        ...
        for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
        {
            ...
            for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
            {
                itT[ i ] = JointPDFIteratorType(this-> m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[this->m_RandomList[s]], this->m_JointPDFs[this->m_RandomList[s]]->GetBufferedRegion() );
            }
    ...
    ::ComputePDFsSingleThreaded( const ParametersType & parameters ) const
    {
        ...
        for( fiter = fbegin; fiter != fend; ++fiter )
        {
            ...
            if ( numSamplesOk > this->m_NumberOfChannels)
            {
    ...
    ::ThreadedComputePDFs( ThreadIdType threadId )
    {
        ...
        std::vector<JointPDFPointer> & jointPDFs = this->m_MCNJEGetValueAndDerivativePerThreadVariables[ threadId ].st_JointPDFs;
        std::vector<SizeValueType> & NumberOfPixelsCountedVector = this->m_MCNJEGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCountedVector;
        SizeValueType & NumberOfPixelsCounted = this->m_MCNJEGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCounted;
    ...
    ::LaunchComputeDerivativeLowMemoryThreaderCallback( void ) const
    {
        typename ThreaderType::Pointer local_threader = ThreaderType::New();
        local_threader->SetNumberOfThreads( this->m_NumberOfThreads );
        local_threader->SetSingleMethod( this->ComputeDerivativeLowMemoryThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_MCNJEThreaderParameters ) ) );
    ...
    ::AfterThreadedComputeDerivativeLowMemory( std::vector<DerivativeType> & derivatives ) const
    {
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            std::vector<DerivativeType> & derivative = this->m_MCNJEGetValueAndDerivativePerThreadVariables[ i ].st_Derivatives;
    ...
    ::ThreadedComputeDerivativeLowMemory( ThreadIdType threadId )
    {
        ...
        std::vector<DerivativeType> & derivatives = this->m_MCNJEGetValueAndDerivativePerThreadVariables[ threadId ].st_Derivatives;
...
#endif // end #ifndef _itkMCNJE_HXX__

#ifndef __elxLLEMetric_H__
#define __elxLLEMetric_H__
...
namespace elastix
{
    ...
    class LLEMetric : public itk::LLEMetric< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef LLEMetric      Self;
            typedef itk::LLEMetric< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( LLEMetric, itk::LLEMetric );
        
            elxClassNameMacro( "LLEMetric" );
        ...
        private:
            ...
            LLEMetric( const Self & );  // purposely not implemented
...
#include "elxLLEMetric.hxx"
#endif

#endif // end #ifndef __elxLLEMetric_H__

#ifndef __elxLLEMetric_HXX__
#define __elxLLEMetric_HXX__
...
namespace elastix
{
    ...
    ::Initialize( void ) throw ( itk::ExceptionObject )
    {
        ...
        timer.Stop();
        elxout << "Initialization of LLEMetric metric took: "
    ...
    ::BeforeRegistration( void )
    {
        ...
        int numberOfEigenValues = 3;
        this->GetConfiguration()->ReadParameter( numberOfEigenValues,"NumberOfEigenValues", this->GetComponentLabel(),0, 0 );
        this->SetNumberOfEigenValues( numberOfEigenValues );
    ...
    ::BeforeEachResolution( void )
    {
        ...
        {
            this->SetANNStandardTreeSearch( nearestNeighbours );
        }
...
#endif // end #ifndef _elxLLEMetric_HXX__

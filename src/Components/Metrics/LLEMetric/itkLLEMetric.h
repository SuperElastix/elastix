...
#ifndef __itkLLEMetric_h
#define __itkLLEMetric_h
...
public:
  ...
  itkTypeMacro( LLEMetric, AdvancedImageToImageMetric );
 ...
 typedef typename
  ...
  virtual void Initialize(void) throw ( ExceptionObject );
    ...
    itkSetMacro( NumberOfEigenValues, unsigned int );
...
#include "itkLLEMetric.hxx"
#endif

#endif // end #ifndef __itkLLEMetric_h

#ifndef __elxProbabilityAverageNormalizedMutualInformationMetric_H__
#define __elxProbabilityAverageNormalizedMutualInformationMetric_H__
...
namespace elastix
{
    ...
    class ProbabilityAverageNormalizedMutualInformationMetric : public itk::ProbabilityAverageNormalizedMutualInformationMetric< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef ProbabilityAverageNormalizedMutualInformationMetric                                                                                                            Self;
            typedef itk::ProbabilityAverageNormalizedMutualInformationMetric< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( ProbabilityAverageNormalizedMutualInformationMetric, itk::ProbabilityAverageNormalizedMutualInformationMetric );
        
            elxClassNameMacro( "ProbabilityAverageNormalizedMutualInformationMetric" );
...
#include "elxProbabilityAverageNormalizedMutualInformationMetric.hxx"
#endif

#endif // end #ifndef __elxProbabilityAverageNormalizedMutualInformationMetric_H__

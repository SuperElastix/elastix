#ifndef _itkProbabilityAverageNormalizedMutualInformationMetric_HXX__
#define _itkProbabilityAverageNormalizedMutualInformationMetric_HXX__

#include "itkProbabilityAverageNormalizedMutualInformationMetric.h"
...
namespace itk
{
    ...
    ProbabilityAverageNormalizedMutualInformationMetric< TFixedImage, TMovingImage >
    ::ProbabilityAverageNormalizedMutualInformationMetric()
    {
        
        this->m_ProbabilityAverageNormalizedMutualInformationMetricThreaderParameters.m_Metric = this;
        
        this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables     = NULL;
        this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariablesSize = 0;
    ...
    ::~ProbabilityAverageNormalizedMutualInformationMetric()
    {
        delete[] this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables;
    }
    ...
    template< class TFixedImage, class TMovingImage >
    typename PAverageNormalizedMutualInformationMetric< TFixedImage, TMovingImage >::MeasureType
    ProbabilityAverageNormalizedMutualInformationMetric< TFixedImage, TMovingImage >
    ::GetValue( const ParametersType & parameters ) const
    {
        ...
        for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
        {
            ...
            PANMI += static_cast< MeasureType >( sumnum / sumden );
        }
        
        return static_cast< MeasureType >( -1.0 * PANMI / static_cast<float>(this->m_NumSamplesLastDimension) );
    ...
    ::GetValueAndAnalyticalDerivative( const ParametersType & parameters, MeasureType & value, DerivativeType & derivative ) const
    {
        ...
        for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
        {
            ...
            while( fixedPDFit != fixedPDFend )
            {
                ...
                while( movingPDFit != movingPDFend )
                {
                    ...
                    {
                        derivit = derivbegin;
                        const double pRatio      = (values[s] * vcl_log(jointPDFValue) - logFixedImagePDFValue -logMovingImagePDFValue) / entropies[s];
        ...
        value = static_cast< MeasureType >( - 1.0 * PANMI / static_cast<float>(this->m_NumSamplesLastDimension));
    ...
    ::GetValueAndAnalyticalDerivativeLowMemory( const ParametersType & parameters, MeasureType & value, DerivativeType & derivative ) const
    {
        ...
        for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
        {
            ...
            this->ComputeLogMarginalPDF( this->m_FixedImageMarginalPDFs[this->m_RandomList[s]] );
            this->ComputeLogMarginalPDF( this->m_MovingImageMarginalPDFs[this->m_RandomList[s]] );
            this->ComputeValueAndPRatioArray( nMI, s);
            PANMI += nMI / static_cast<float>(this->m_NumSamplesLastDimension);
        ...
        value = static_cast< MeasureType >( -1.0 * PANMI );
    ...
    ::ComputePDFsThreaderCallback( void * arg )
    {
        ...
        ProbabilityAverageNormalizedMutualInformationMetricMultiThreaderParameterType * temp
        = static_cast< ProbabilityAverageNormalizedMutualInformationMetricMultiThreaderParameterType * >( infoStruct->UserData );
    ...
    ::LaunchComputePDFsThreaderCallback( void ) const
    {
        ...
        local_threader->SetSingleMethod( this->ComputePDFsThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_ProbabilityAverageNormalizedMutualInformationMetricThreaderParameters ) ) );
    ...
    ::InitializeThreadingParameters( void ) const
    {
        ...
        if( this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariablesSize != this->m_NumberOfThreads )
        {
            delete[] this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables;
            this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables = new AlignedProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadStruct[this->m_NumberOfThreads ];
            this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariablesSize = this->m_NumberOfThreads;
        }
        
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted = NumericTraits< SizeValueType >::Zero;
            this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector.assign(this->m_NumSamplesLastDimension, NumericTraits< SizeValueType >::Zero);
            this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs.resize(lastDimSize);
            
            for(unsigned int d = 0; d < lastDimSize; d++)
            {
                JointPDFPointer & jointPDF = this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[ d ];
    ...
    ::AfterThreadedComputePDFs( void ) const
    {
        ...
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_NumberOfPixelsCounted += this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted;
            
            for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
            {
                this->m_NumberOfPixelsCountedVector[this->m_RandomList[s]] += this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector[this->m_RandomList[s]];
            }
        ...
        for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
        {
            ...
            for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
            {
                itT[ i ] = JointPDFIteratorType(this-> m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[this->m_RandomList[s]], this->m_JointPDFs[this->m_RandomList[s]]->GetBufferedRegion() );
            }
    ...
    ::ThreadedComputePDFs( ThreadIdType threadId )
    {
        ...
        std::vector<JointPDFPointer> & jointPDFs = this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ threadId ].st_JointPDFs;
        std::vector<SizeValueType> & NumberOfPixelsCountedVector = this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCountedVector;
        SizeValueType & NumberOfPixelsCounted = this->m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCounted;
    ...
    ::LaunchComputeDerivativeLowMemoryThreaderCallback( void ) const
    {
        typename ThreaderType::Pointer local_threader = ThreaderType::New();
        local_threader->SetNumberOfThreads( this->m_NumberOfThreads );
        local_threader->SetSingleMethod( this->ComputeDerivativeLowMemoryThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_ProbabilityAverageNormalizedMutualInformationMetricThreaderParameters ) ) );
...
#endif // end #ifndef _itkProbabilityAverageNormalizedMutualInformationMetric_HXX__

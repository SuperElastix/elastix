#ifndef __itkProbabilityAverageNormalizedMutualInformationMetric_H__
#define __itkProbabilityAverageNormalizedMutualInformationMetric_H__
...
namespace itk
{
    ...
    class ProbabilityAverageNormalizedMutualInformationMetric : public PAverageNormalizedMutualInformationMetric< TFixedImage, TMovingImage >
    {
        public:
        
            typedef ProbabilityAverageNormalizedMutualInformationMetric                    Self;
            typedef PAverageNormalizedMutualInformationMetric<TFixedImage, TMovingImage >  Superclass;
            typedef SmartPointer< Self >                                        Pointer;
            typedef SmartPointer< const Self >                                  ConstPointer;
        
            itkNewMacro( Self) ;
        
            itkTypeMacro(ProbabilityAverageNormalizedMutualInformationMetric, PAverageNormalizedMutualInformationMetric );
        ...
        protected:
            ...
            virtual ~ProbabilityAverageNormalizedMutualInformationMetric();
        ...
        struct ProbabilityAverageNormalizedMutualInformationMetricMultiThreaderParameterType
        {
            Self * m_Metric;
        };
        
        ProbabilityAverageNormalizedMutualInformationMetricMultiThreaderParameterType m_ProbabilityAverageNormalizedMutualInformationMetricThreaderParameters;
        
        struct ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadStruct
        {
        ...
        itkPadStruct( ITK_CACHE_LINE_ALIGNMENT, ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadStruct, PaddedProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadStruct );
        itkAlignedTypedef( ITK_CACHE_LINE_ALIGNMENT, PaddedProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadStruct, AlignedProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadStruct );
        
        mutable AlignedProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadStruct *  m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariables;
        mutable ThreadIdType                                                                    m_ProbabilityAverageNormalizedMutualInformationMetricGetValueAndDerivativePerThreadVariablesSize;
        ...
        private:
            ...
            ProbabilityAverageNormalizedMutualInformationMetric( const Self & ); // purposely not implemented
...
#include "itkProbabilityAverageNormalizedMutualInformationMetric.hxx"
#endif

#endif // end #ifndef __itkProbabilityAverageNormalizedMutualInformationMetric_H__

#ifndef __elxLinearGroupwiseNMI_H__
#define __elxLinearGroupwiseNMI_H__
...
namespace elastix
{
    ...
    class LinearGroupwiseNMI : public itk::LinearGroupwiseNMI< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef LinearGroupwiseNMI      Self;
            typedef itk::LinearGroupwiseNMI< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( LinearGroupwiseNMI, itk::LinearGroupwiseNMI );
        
            elxClassNameMacro( "LinearGroupwiseNMI" );
...
#include "elxLinearGroupwiseNMI.hxx"
#endif

#endif // end #ifndef __elxLinearGroupwiseNMI_H__

#ifndef __elxLinearGroupwiseNMI_HXX__
#define __elxLinearGroupwiseNMI_HXX__
...
namespace elastix
{
    ...
    ::Initialize( void ) throw ( itk::ExceptionObject )
    {
        ...
        timer.Stop();
        elxout << "Initialization of LinearGroupwiseNMI metric took: "
...
#endif // end #ifndef _elxLinearGroupwiseNMI_HXX__

#ifndef _itkLinearGroupwiseNMI_HXX__
#define _itkLinearGroupwiseNMI_HXX__

#include "itkLinearGroupwiseNMI.h"
...
namespace itk
{
    ...
    LinearGroupwiseNMI< TFixedImage, TMovingImage >
    ::LinearGroupwiseNMI()
    {
        this->m_UseDerivative = true;
        this->SetUseImageSampler( true );
        
        this->m_LinearGroupwiseNMIThreaderParameters.m_Metric = this;
        
        this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables     = NULL;
        this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariablesSize = 0;
    ...
    ::~LinearGroupwiseNMI()
    {
        delete[] this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables;
    ...
    ::ComputePDFsThreaderCallback( void * arg )
    {
        ...
        LinearGroupwiseNMIMultiThreaderParameterType * temp
        = static_cast< LinearGroupwiseNMIMultiThreaderParameterType * >( infoStruct->UserData );
    ...
    ::LaunchComputePDFsThreaderCallback( void ) const
    {
        ...
        local_threader->SetSingleMethod( this->ComputePDFsThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_LinearGroupwiseNMIThreaderParameters ) ) );
    ...
    ::InitializeThreadingParameters( void ) const
    {
        ...
        if( this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariablesSize != this->m_NumberOfThreads )
        {
            delete[] this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables;
            this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables = new AlignedLinearGroupwiseNMIGetValueAndDerivativePerThreadStruct[this->m_NumberOfThreads ];
            this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariablesSize = this->m_NumberOfThreads;
        }
        
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted = NumericTraits< SizeValueType >::Zero;
            this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector.assign(lastDimSize, NumericTraits< SizeValueType >::Zero);
            this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs.resize(lastDimSize);
            this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_Derivatives.resize(lastDimSize);

            for(unsigned int d = 0; d < lastDimSize; d++)
            {
                JointPDFPointer & jointPDF = this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[ d ];
                ...
                if (this->m_UseExplicitPDFDerivatives)
                {
                    this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_Derivatives.clear();
                }
    ...
    ::AfterThreadedComputePDFs( void ) const
    {
        ...
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_NumberOfPixelsCounted += this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted;

            for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
            {
                this->m_NumberOfPixelsCountedVector[this->m_RandomList[s]] += this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector[this->m_RandomList[s]];
            }
        ...
        for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
        {
            ...
            for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
            {
                itT[ i ] = JointPDFIteratorType(this-> m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[this->m_RandomList[s]], this->m_JointPDFs[this->m_RandomList[s]]->GetBufferedRegion() );
            }
    ...
    ::ThreadedComputePDFs( ThreadIdType threadId )
    {
        ...
        std::vector<JointPDFPointer> & jointPDFs = this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ threadId ].st_JointPDFs;
        std::vector<SizeValueType> & NumberOfPixelsCountedVector = this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCountedVector;
        SizeValueType & NumberOfPixelsCounted = this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCounted;
    ...
    ::LaunchComputeDerivativeLowMemoryThreaderCallback( void ) const
    {
        typename ThreaderType::Pointer local_threader = ThreaderType::New();
        local_threader->SetNumberOfThreads( this->m_NumberOfThreads );
        local_threader->SetSingleMethod( this->ComputeDerivativeLowMemoryThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_LinearGroupwiseNMIThreaderParameters ) ) );
    ...
    ::AfterThreadedComputeDerivativeLowMemory( std::vector<DerivativeType> & derivatives ) const
    {
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            std::vector<DerivativeType> & derivative = this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ i ].st_Derivatives;
    ...
    ::ThreadedComputeDerivativeLowMemory( ThreadIdType threadId )
    {
        ...
        std::vector<DerivativeType> & derivatives = this->m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables[ threadId ].st_Derivatives;
...
#endif // end #ifndef _itkLinearGroupwiseNMI_HXX__

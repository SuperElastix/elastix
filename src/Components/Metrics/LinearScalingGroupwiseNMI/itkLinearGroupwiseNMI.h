#ifndef __itkLinearGroupwiseNMI_H__
#define __itkLinearGroupwiseNMI_H__
...
namespace itk
{
    ...
    class LinearGroupwiseNMI : public LinearScalingGroupwiseMetric< TFixedImage, TMovingImage >
    {
    public:
        
        typedef LinearGroupwiseNMI                          Self;
        ...
        itkTypeMacro( LinearGroupwiseNMI, LinearScalingGroupwiseMetric );
    ...
    protected:
        ...
        struct LinearGroupwiseNMIMultiThreaderParameterType
        {
            Self * m_Metric;
        };
        
        LinearGroupwiseNMIMultiThreaderParameterType m_LinearGroupwiseNMIThreaderParameters;
        
        struct LinearGroupwiseNMIGetValueAndDerivativePerThreadStruct
        {
        ...
        itkPadStruct( ITK_CACHE_LINE_ALIGNMENT, LinearGroupwiseNMIGetValueAndDerivativePerThreadStruct, PaddedLinearGroupwiseNMIGetValueAndDerivativePerThreadStruct );
        itkAlignedTypedef( ITK_CACHE_LINE_ALIGNMENT, PaddedLinearGroupwiseNMIGetValueAndDerivativePerThreadStruct, AlignedLinearGroupwiseNMIGetValueAndDerivativePerThreadStruct );
        
        mutable AlignedLinearGroupwiseNMIGetValueAndDerivativePerThreadStruct *  m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariables;
        mutable ThreadIdType                                                                    m_LinearGroupwiseNMIGetValueAndDerivativePerThreadVariablesSize;
    ...
    private:
        ...
        LinearGroupwiseNMI( const Self & ); // purposely not implemented
...
#include "itkLinearGroupwiseNMI.hxx"
#endif

#endif // end #ifndef __itkLinearGroupwiseNMI_H__

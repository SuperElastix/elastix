#ifndef __itkMCPAverageNormalizedMutualInformationMetric_H__
#define __itkMCPAverageNormalizedMutualInformationMetric_H__
...
namespace itk
{
    ...
    class MCPAverageNormalizedMutualInformationMetric : public AdvancedImageToImageMetric< TFixedImage, TMovingImage >
    {
        public:
        
            typedef MCPAverageNormalizedMutualInformationMetric                          Self;
            typedef AdvancedImageToImageMetric< TFixedImage, TMovingImage > Superclass;
            typedef SmartPointer< Self >                                    Pointer;
            typedef SmartPointer< const Self >                              ConstPointer;
        
            itkTypeMacro( MCPAverageNormalizedMutualInformationMetric, AdvancedImageToImageMetric );
            ...
            itkSetMacro( Channels, std::vector<unsigned int> );
            ...
            itkGetConstMacro( Channels, std::vector<unsigned int> );
        ...
        protected:
            ...
            MCPAverageNormalizedMutualInformationMetric();
        
            virtual ~MCPAverageNormalizedMutualInformationMetric();
            ...
            std::vector<unsigned int>                     m_NumberOfChannels;
            ...
            virtual void ComputeValueAndPRatioArray( double & nMI, unsigned int n ) const;
        
        private:
        
            MCPAverageNormalizedMutualInformationMetric( const Self & ); // purposely not implemented
...
#include "itkMCPAverageNormalizedMutualInformationMetric.hxx"
#endif

#endif // end #ifndef __itkMCPAverageNormalizedMutualInformationMetric_H__

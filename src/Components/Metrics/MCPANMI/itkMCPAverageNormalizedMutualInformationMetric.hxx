#ifndef _itkMCPAverageNormalizedMutualInformationMetric_HXX__
#define _itkMCPAverageNormalizedMutualInformationMetric_HXX__
...
namespace itk
{
    ...
    MCPAverageNormalizedMutualInformationMetric< TFixedImage, TMovingImage >
    ...
    ::InitializeVectors( void )
    {
        ...
        {
            if (prev != this->m_Channels[i])
            {
                this->m_NumberOfChannels.push_back(subtotal);
                subtotal = 1;
                total++;
            }
            else
            ...
            prev = this->m_Channels[i];
        }
        this->m_NumberOfChannels.push_back(subtotal);
        this->m_NumberOfImages = total;
        this->m_NumberOfChannels.resize(this->m_NumberOfImages);
...
#endif // end #ifndef _itkMCPAverageNormalizedMutualInformationMetric_HXX__

#ifndef __elxMCPANMI_H__
#define __elxMCPANMI_H__
...
namespace elastix
{
    ...
    class MCPANMI : public itk::MCPANMI< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef MCPANMI                                                                                                            Self;
            typedef itk::MCPANMI< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( MCPANMI, itk::MCPANMI );
        
            elxClassNameMacro( "MCPANMI" );
...
#include "elxMCPANMI.hxx"
#endif

#endif // end #ifndef __elxMCPANMI_H__

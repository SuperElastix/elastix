#ifndef _itkLinearGroupwiseMI_HXX__
#define _itkLinearGroupwiseMI_HXX__

#include "itkLinearGroupwiseMI.h"
...
namespace itk
{
    ...
    LinearGroupwiseMI< TFixedImage, TMovingImage >
    ::LinearGroupwiseMI()
    {
        ...
        this->m_LinearGroupwiseMIThreaderParameters.m_Metric = this;
        
        this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables     = NULL;
        this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariablesSize = 0;
    ...
    ::~LinearGroupwiseMI()
    {
        delete[] this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables;
    ...
    ::InitializeVectors(void)
    {
        ...
        for(unsigned int d = 0; d < lastDimSize; d++)
        {
            ...
            this->m_FixedImageMinLimits[d] = static_cast< FixedImageLimiterOutputType >(trueMinTemp - this->m_FixedImageLimitRangeRatio * ( trueMaxTemp - trueMinTemp ) );
            this->m_FixedImageMaxLimits[d] =  static_cast< FixedImageLimiterOutputType >(trueMaxTemp + this->m_FixedImageLimitRangeRatio * ( trueMaxTemp - trueMinTemp ) );
            
            if( this->m_FixedImageTrueMins[d] < 1)
            {
                intensityConstants[d] = 1 - this->m_FixedImageTrueMins[d];
            }
        ...
        this->m_MovingImageTrueMin = static_cast<MovingImagePixelType>(this->m_TemplateImage->CalculateIntensity(this->m_FixedImageTrueMins, lastDimSize));
        this->m_MovingImageTrueMax = static_cast<MovingImagePixelType>(this->m_TemplateImage->CalculateIntensity(this->m_FixedImageTrueMaxs, lastDimSize));
    ...
    ::InitializeHistograms(void)
    {
        ...
        const double smallNumberMoving = smallNumberRatio * ( this->m_MovingImageMaxLimit - this->m_MovingImageMinLimit ) / static_cast< double >( this->m_NumberOfFixedHistogramBins - 2 * movingPadding - 1 );
    ...
    ::ComputePDFsThreaderCallback( void * arg )
    {
        ...
        LinearGroupwiseMIMultiThreaderParameterType * temp
        = static_cast< LinearGroupwiseMIMultiThreaderParameterType * >( infoStruct->UserData );
    ...
    ::LaunchComputePDFsThreaderCallback( void ) const
    {
        ...
        local_threader->SetSingleMethod( this->ComputePDFsThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_LinearGroupwiseMIThreaderParameters ) ) );
    ...
    ::InitializeThreadingParameters( void ) const
    {
        ...
        if( this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariablesSize != this->m_NumberOfThreads )
        {
            delete[] this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables;
            this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables = new AlignedLinearGroupwiseMIGetValueAndDerivativePerThreadStruct[this->m_NumberOfThreads ];
            this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariablesSize = this->m_NumberOfThreads;
        }
        
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted = NumericTraits< SizeValueType >::Zero;
            this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector.assign(this->m_NumSamplesLastDimension, NumericTraits< SizeValueType >::Zero);
            this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs.resize(lastDimSize);
            this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_Derivatives.resize(lastDimSize);

            for(unsigned int d = 0; d < lastDimSize; d++)
            {
                JointPDFPointer & jointPDF = this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[ d ];
                ...
                if (this->m_UseExplicitPDFDerivatives)
                {
                    this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_Derivatives.clear();
                }
    ...
    ::AfterThreadedComputePDFs( void ) const
    {
        ...
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_NumberOfPixelsCounted += this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted;

            for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
            {
                this->m_NumberOfPixelsCountedVector[this->m_RandomList[s]] += this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector[this->m_RandomList[s]];
            }
        ...
        for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
        {
            ...
            for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
            {
                itT[ i ] = JointPDFIteratorType(this-> m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[this->m_RandomList[s]], this->m_JointPDFs[this->m_RandomList[s]]->GetBufferedRegion() );
            }
        ...
        for( fiter = fbegin; fiter != fend; ++fiter )
        {
            ...
            if ( numSamplesOk > 1)
            {
                ...
                for( unsigned int o = 0; o < numSamplesOk; o++ )
                {
                    ...
                    this->UpdateJointPDFAndDerivatives(imageValues, templateIntensity, 0, 0, this->m_JointPDFs[positions[o]].GetPointer(), o, positions);
    ...
    ::ThreadedComputePDFs( ThreadIdType threadId )
    {
        ...
        std::vector<JointPDFPointer> & jointPDFs = this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ threadId ].st_JointPDFs;
        std::vector<SizeValueType> & NumberOfPixelsCountedVector = this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCountedVector;
        SizeValueType & NumberOfPixelsCounted = this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCounted;
        ...
        for( fiter = fbegin; fiter != fend; ++fiter )
        {
            ...
            if ( numSamplesOk > 1)
            {
                ...
                for( unsigned int o = 0; o < numSamplesOk; o++ )
                {
                    ...
                    this->UpdateJointPDFAndDerivatives(imageValues, templateIntensity, 0, 0, jointPDFs[positions[o]].GetPointer(), o, positions);
    ...
    ::ComputePDFsAndPDFDerivativesSingleThreaded( const ParametersType & parameters ) const
    {
        ...
        for( fiter = fbegin; fiter != fend; ++fiter)
        {
            ...
            if ( numSamplesOk > 1)
            {
                ...
                {
                    this->m_NumberOfPixelsCountedVector[positions[o]]++;
                    this->UpdateJointPDFAndDerivatives(imageValues, templateIntensity, &(imageJacobians), &(nzjis), this->m_JointPDFs[positions[o]].GetPointer(), o, positions);
    ...
    ::LaunchComputeDerivativeLowMemoryThreaderCallback( void ) const
    {
        typename ThreaderType::Pointer local_threader = ThreaderType::New();
        local_threader->SetNumberOfThreads( this->m_NumberOfThreads );
        local_threader->SetSingleMethod( this->ComputeDerivativeLowMemoryThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_LinearGroupwiseMIThreaderParameters ) ) );
    ...
    ::AfterThreadedComputeDerivativeLowMemory( std::vector<DerivativeType> & derivatives ) const
    {
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            std::vector<DerivativeType> & derivative = this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ i ].st_Derivatives;
    ...
    ::ComputeDerivativeLowMemorySingleThreaded( std::vector<DerivativeType> & derivatives) const
    {
        ...
        for( fiter = fbegin; fiter != fend; ++fiter)
        {
            ...
            if ( numSamplesOk > 1)
            {
                ...
                for( unsigned int o = 0; o < numSamplesOk; o++ )
                {
                    this->UpdateDerivativeLowMemory(imageValues, templateIntensity, &(imageJacobians), &(nzjis), o, positions, derivatives);
    ...
    ::ThreadedComputeDerivativeLowMemory( ThreadIdType threadId )
    {
        ...
        std::vector<DerivativeType> & derivatives = this->m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables[ threadId ].st_Derivatives;
    ...
    void
    LinearGroupwiseMI< TFixedImage, TMovingImage >
    ::UpdateJointPDFAndDerivatives(const std::vector<double> & fixedImageValue, const double & movingImageValue, const std::vector<DerivativeType> * imageJacobian, const std::vector<NonZeroJacobianIndicesType> * nzji, JointPDFType * jointPDF, const unsigned int n, const std::vector<unsigned int> & positions ) const
    {
        ...
        {
            std::cout << " Warning: Index Out of Bounds:" << fixedImageValue[n] << "\t" << fixedImageParzenWindowTerm << "\t" << this->m_FixedImageBinSizes[positions[n]] << "\t"<< this->m_FixedImageNormalizedMins[positions[n]] << "\t" << movingImageValue << "\t"  << movingImageParzenWindowTerm << "\t" << this->m_MovingImageBinSize  << "\t" << this->m_MovingImageNormalizedMin << "\t" << n << "\t" << positions[n] << "\n";
        }
        else
        {
    ...
    ::UpdateJointPDFDerivatives( const std::vector<double> & fixedImageValue, const double & movingImageValue, const JointPDFIndexType & pdfIndex, double factor, double factorr, const std::vector<DerivativeType> * imageJacobian, const std::vector<NonZeroJacobianIndicesType> * nzji, const unsigned int n, const std::vector<unsigned int> & positions ) const
    {
        ...
        for ( unsigned int o = 0; o < positions.size(); o++)
        {
            ...
            for ( unsigned int i = 0; i < (*nzji)[o].size(); i++)
            {
                ...
                if ( o == n)
                {
                    *( ptr ) -= static_cast< PDFDerivativeValueType >( (*imjac) * ((factor / static_cast<double>(positions.size())) * this->m_TemplateImage->CalculateRatio(fixedImageValue[o],movingImageValue,positions[o]) + factorr) );
                }
                else
                {
                    *( ptr ) -= static_cast< PDFDerivativeValueType >( (*imjac) * factor / static_cast<double>(positions.size()) * this->m_TemplateImage->CalculateRatio(fixedImageValue[o],movingImageValue,positions[o]));
                }
                imjac++;
    ...
    void
    LinearGroupwiseMI< TFixedImage, TMovingImage >
    ::UpdateDerivativeLowMemory(const std::vector<double> & fixedImageValue, const double & movingImageValue, const std::vector<DerivativeType> * imageJacobian, const std::vector<NonZeroJacobianIndicesType> * nzji, const unsigned int n, const std::vector<unsigned int> & positions, std::vector<DerivativeType> & derivatives) const
    {
        const double fixedImageParzenWindowTerm = fixedImageValue[n] / this->m_FixedImageBinSizes[positions[n]] - this->m_FixedImageNormalizedMins[positions[n]];
        const double movingImageParzenWindowTerm = movingImageValue / this->m_MovingImageBinSize - this->m_MovingImageNormalizedMin;
        const OffsetValueType fixedImageParzenWindowIndex = static_cast< OffsetValueType >( vcl_floor(fixedImageParzenWindowTerm + this->m_FixedParzenTermToIndexOffset ) );
        ...
        else
        {
            ...
            for ( unsigned int o = 0; o < positions.size(); o++)
            {
                ...
                for ( unsigned int i = 0; i < (*nzji)[o].size(); i++)
                {
                    ...
                    if ( o == n)
                    {
                        derivatives[positions[o]][ mu ] -= static_cast<  double >( (*imjac) * (extraSum + regSum * this->m_TemplateImage->CalculateRatio(fixedImageValue[o],movingImageValue,positions[o]) / static_cast<double>(positions.size())) );
                    }
                    else
                    {
                        derivatives[positions[o]][ mu ] -= static_cast<  double >( (*imjac) * regSum * this->m_TemplateImage->CalculateRatio(fixedImageValue[o],movingImageValue,positions[o]) / static_cast<double>(positions.size()) );
                    }
...
#endif // end #ifndef _itkLinearGroupwiseMI_HXX__

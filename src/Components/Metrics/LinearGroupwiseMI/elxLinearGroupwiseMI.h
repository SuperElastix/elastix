#ifndef __elxLinearGroupwiseMI_H__
#define __elxLinearGroupwiseMI_H__
...
namespace elastix
{
    ...
    class LinearGroupwiseMI : public itk::LinearGroupwiseMI< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef LinearGroupwiseMI      Self;
            typedef itk::LinearGroupwiseMI< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( LinearGroupwiseMI, itk::LinearGroupwiseMI );
        
            elxClassNameMacro( "LinearGroupwiseMI" );
...
#include "elxLinearGroupwiseMI.hxx"
#endif

#endif // end #ifndef __elxLinearGroupwiseMI_H__

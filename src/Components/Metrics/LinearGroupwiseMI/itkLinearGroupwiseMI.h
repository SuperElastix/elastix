#ifndef __itkLinearGroupwiseMI_H__
#define __itkLinearGroupwiseMI_H__
...
namespace itk
{
    ...
    class LinearGroupwiseMI : public LinearScalingGroupwiseMetric< TFixedImage, TMovingImage >
    {
    public:
        
        typedef LinearGroupwiseMI                          Self;
        ...
        itkTypeMacro( LinearGroupwiseMI, LinearScalingGroupwiseMetric );
    ...
    protected:
        ...
        struct LinearGroupwiseMIMultiThreaderParameterType
        {
            Self * m_Metric;
        };
        
        LinearGroupwiseMIMultiThreaderParameterType m_LinearGroupwiseMIThreaderParameters;
        
        struct LinearGroupwiseMIGetValueAndDerivativePerThreadStruct
        {
        ...
        itkPadStruct( ITK_CACHE_LINE_ALIGNMENT, LinearGroupwiseMIGetValueAndDerivativePerThreadStruct, PaddedLinearGroupwiseMIGetValueAndDerivativePerThreadStruct );
        itkAlignedTypedef( ITK_CACHE_LINE_ALIGNMENT, PaddedLinearGroupwiseMIGetValueAndDerivativePerThreadStruct, AlignedLinearGroupwiseMIGetValueAndDerivativePerThreadStruct );
        
        mutable AlignedLinearGroupwiseMIGetValueAndDerivativePerThreadStruct *  m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariables;
        mutable ThreadIdType                                                                    m_LinearGroupwiseMIGetValueAndDerivativePerThreadVariablesSize;
        ...
        mutable std::vector<int>                    m_NumberOfPixelsCountedVector;
        ...
        void ComputeValueAndPRatioArray( double & MI, unsigned int n ) const;
        ...
        void UpdateJointPDFAndDerivatives(const std::vector<double> & fixedImageValue, const double & movingImageValue, const std::vector<DerivativeType> * imageJacobian, const std::vector<NonZeroJacobianIndicesType> * nzji, JointPDFType * jointPDF, const unsigned int n, const std::vector<unsigned int> & positions ) const;
        ...
        void UpdateDerivativeLowMemory(const std::vector<double> & fixedImageValue, const double & movingImageValue, const std::vector<DerivativeType> * imageJacobian, const std::vector<NonZeroJacobianIndicesType> * nzji, const unsigned int n, const std::vector<unsigned int> & positions, std::vector<DerivativeType> & derivatives) const;
        
    private:
        
        LinearGroupwiseMI( const Self & ); // purposely not implemented
...
#include "itkLinearGroupwiseMI.hxx"
#endif

#endif // end #ifndef __itkLinearGroupwiseMI_H__

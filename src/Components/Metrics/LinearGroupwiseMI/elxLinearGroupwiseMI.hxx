#ifndef __elxLinearGroupwiseMI_HXX__
#define __elxLinearGroupwiseMI_HXX__

#include "elxLinearGroupwiseMI.h"
...
namespace elastix
{
 ...
 //       timer->StopTimer();
//        elxout << "Initialization of LinearGroupwiseMI metric took: " << static_cast< long >( timer->GetElapsedClockSec() * 1000 ) << " ms." << std::endl;
...
#endif // end #ifndef _elxLinearGroupwiseMI_HXX__

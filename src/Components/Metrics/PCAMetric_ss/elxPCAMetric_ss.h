...
namespace elastix
{
  ...
  public:
    ...
    itkTypeMacro( PCAMetric_ss, itk::PCAMetric_ss );

    /** Name of this class.
     * Use this name in the parameter file to select this specific metric. \n
     * example: <tt>(Metric "PCAMetric_ss")</tt>\n
     */
    elxClassNameMacro( "PCAMetric_ss" );

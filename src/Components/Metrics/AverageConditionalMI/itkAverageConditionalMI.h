#ifndef __itkAverageConditionalMI_H__
#define __itkAverageConditionalMI_H__
...
namespace itk
{
    ...
    class AverageConditionalMI : public LinearScalingGroupwiseMetric< TFixedImage, TMovingImage >
    {
    public:
        
        typedef AverageConditionalMI                          Self;
        ...
        itkTypeMacro( AverageConditionalMI, LinearScalingGroupwiseMetric );
    ...
    protected:
        ...
        struct AverageConditionalMIMultiThreaderParameterType
        {
            Self * m_Metric;
        };
        
        AverageConditionalMIMultiThreaderParameterType m_AverageConditionalMIThreaderParameters;
        
        struct AverageConditionalMIGetValueAndDerivativePerThreadStruct
        {
        ...
        itkPadStruct( ITK_CACHE_LINE_ALIGNMENT, AverageConditionalMIGetValueAndDerivativePerThreadStruct, PaddedAverageConditionalMIGetValueAndDerivativePerThreadStruct );
        itkAlignedTypedef( ITK_CACHE_LINE_ALIGNMENT, PaddedAverageConditionalMIGetValueAndDerivativePerThreadStruct, AlignedAverageConditionalMIGetValueAndDerivativePerThreadStruct );
        
        mutable AlignedAverageConditionalMIGetValueAndDerivativePerThreadStruct *  m_AverageConditionalMIGetValueAndDerivativePerThreadVariables;
        mutable ThreadIdType                                                                    m_AverageConditionalMIGetValueAndDerivativePerThreadVariablesSize;
    ...
    private:
        ...
        AverageConditionalMI( const Self & ); // purposely not implemented
...
#include "itkAverageConditionalMI.hxx"
#endif

#endif // end #ifndef __itkAverageConditionalMI_H__

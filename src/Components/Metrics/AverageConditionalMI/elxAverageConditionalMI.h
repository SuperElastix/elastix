#ifndef __elxAverageConditionalMI_H__
#define __elxAverageConditionalMI_H__
...
namespace elastix
{
    ...
    class AverageConditionalMI : public itk::AverageConditionalMI< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef AverageConditionalMI      Self;
            typedef itk::AverageConditionalMI< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( AverageConditionalMI, itk::AverageConditionalMI );
        
            elxClassNameMacro( "AverageConditionalMI" );
...
#include "elxAverageConditionalMI.hxx"
#endif

#endif // end #ifndef __elxAverageConditionalMI_H__

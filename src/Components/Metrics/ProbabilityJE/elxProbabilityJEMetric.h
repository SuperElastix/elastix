#ifndef __elxProbabilityJEMetric_H__
#define __elxProbabilityJEMetric_H__
...
namespace elastix
{
    ...
    class ProbabilityJEMetric : public itk::ProbabilityJEMetric< typename MetricBase< TElastix >::FixedImageType, typename MetricBase< TElastix >::MovingImageType >, public MetricBase< TElastix >
    {
        public:
        
            typedef ProbabilityJEMetric                                                                                                            Self;
            typedef itk::ProbabilityJEMetric< typename MetricBase< TElastix >::FixedImageType,typename MetricBase< TElastix >::MovingImageType >   Superclass1;
            ...
            itkTypeMacro( ProbabilityJEMetric, itk::ProbabilityJEMetric );
        
            elxClassNameMacro( "ProbabilityJEMetric" );
...
#include "elxProbabilityJEMetric.hxx"
#endif

#endif // end #ifndef __elxProbabilityJEMetric_H__

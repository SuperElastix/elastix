#ifndef __itkPJEMetric_H__
#define __itkPJEMetric_H__
...
namespace itk
{
    ...
    class PJEMetric : public AdvancedImageToImageMetric< TFixedImage, TMovingImage >
    {
        public:
        
            typedef PJEMetric                          Self;
            typedef AdvancedImageToImageMetric< TFixedImage, TMovingImage > Superclass;
            typedef SmartPointer< Self >                                    Pointer;
            typedef SmartPointer< const Self >                              ConstPointer;
        
            itkTypeMacro( PJEMetric, AdvancedImageToImageMetric );
        ...
        private:
            ...
            PJEMetric( const Self & ); // purposely not implemented
...
#include "itkPJEMetric.hxx"
#endif

#endif // end #ifndef __itkPJEMetric_H__

#ifndef _itkProbabilityJEMetric_HXX__
#define _itkProbabilityJEMetric_HXX__

#include "itkProbabilityJEMetric.h"
...
namespace itk
{
    ...
    ProbabilityJEMetric< TFixedImage, TMovingImage >
    ::ProbabilityJEMetric()
    {
        
        this->m_ProbabilityJEMetricThreaderParameters.m_Metric = this;
        
        this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables     = NULL;
        this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariablesSize = 0;
    ...
    ::~ProbabilityJEMetric()
    {
        delete[] this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables;
    }
    ...
    template< class TFixedImage, class TMovingImage >
    typename PJEMetric< TFixedImage, TMovingImage >::MeasureType
    ProbabilityJEMetric< TFixedImage, TMovingImage >
    ...
    ::ComputePDFsThreaderCallback( void * arg )
    {
        ...
        ProbabilityJEMetricMultiThreaderParameterType * temp
        = static_cast< ProbabilityJEMetricMultiThreaderParameterType * >( infoStruct->UserData );
    ...
    ::LaunchComputePDFsThreaderCallback( void ) const
    {
        ...
        local_threader->SetSingleMethod( this->ComputePDFsThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_ProbabilityJEMetricThreaderParameters ) ) );
    ...
    ::InitializeThreadingParameters( void ) const
    {
        ...
        if( this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariablesSize != this->m_NumberOfThreads )
        {
            delete[] this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables;
            this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables = new AlignedProbabilityJEMetricGetValueAndDerivativePerThreadStruct[this->m_NumberOfThreads ];
            this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariablesSize = this->m_NumberOfThreads;
        }
        
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted = NumericTraits< SizeValueType >::Zero;
            this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector.assign(this->m_NumSamplesLastDimension, NumericTraits< SizeValueType >::Zero);
            this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs.resize(lastDimSize);
            
            for(unsigned int d = 0; d < lastDimSize; d++)
            {
                JointPDFPointer & jointPDF = this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[ d ];
    ...
    ::AfterThreadedComputePDFs( void ) const
    {
        ...
        for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
        {
            this->m_NumberOfPixelsCounted += this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCounted;
            
            for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
            {
                this->m_NumberOfPixelsCountedVector[this->m_RandomList[s]] += this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ i ].st_NumberOfPixelsCountedVector[this->m_RandomList[s]];
            }
        ...
        for(unsigned int s = 0; s < this->m_NumSamplesLastDimension; s++)
        {
            ...
            for( ThreadIdType i = 0; i < this->m_NumberOfThreads; ++i )
            {
                itT[ i ] = JointPDFIteratorType(this-> m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ i ].st_JointPDFs[this->m_RandomList[s]], this->m_JointPDFs[this->m_RandomList[s]]->GetBufferedRegion() );
            }
    ...
    ::ThreadedComputePDFs( ThreadIdType threadId )
    {
        ...
        std::vector<JointPDFPointer> & jointPDFs = this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ threadId ].st_JointPDFs;
        std::vector<SizeValueType> & NumberOfPixelsCountedVector = this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCountedVector;
        SizeValueType & NumberOfPixelsCounted = this->m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables[ threadId ].st_NumberOfPixelsCounted;
    ...
    ::LaunchComputeDerivativeLowMemoryThreaderCallback( void ) const
    {
        typename ThreaderType::Pointer local_threader = ThreaderType::New();
        local_threader->SetNumberOfThreads( this->m_NumberOfThreads );
        local_threader->SetSingleMethod( this->ComputeDerivativeLowMemoryThreaderCallback, const_cast< void * >( static_cast< const void * >( &this->m_ProbabilityJEMetricThreaderParameters ) ) );
...
#endif // end #ifndef _itkProbabilityJEMetric_HXX__

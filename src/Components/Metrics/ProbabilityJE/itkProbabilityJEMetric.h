#ifndef __itkProbabilityJEMetric_H__
#define __itkProbabilityJEMetric_H__

#include "itkPJEMetric.h"
...
namespace itk
{
    ...
    class ProbabilityJEMetric : public PJEMetric< TFixedImage, TMovingImage >
    {
        public:
        
            typedef ProbabilityJEMetric                    Self;
            typedef PJEMetric<TFixedImage, TMovingImage >  Superclass;
            typedef SmartPointer< Self >                                        Pointer;
            typedef SmartPointer< const Self >                                  ConstPointer;
        
            itkNewMacro( Self) ;
        
            itkTypeMacro(ProbabilityJEMetric, PJEMetric );
        ...
        struct ProbabilityJEMetricMultiThreaderParameterType
        {
            Self * m_Metric;
        };
        
        ProbabilityJEMetricMultiThreaderParameterType m_ProbabilityJEMetricThreaderParameters;
        
        struct ProbabilityJEMetricGetValueAndDerivativePerThreadStruct
        {
        ...
        itkPadStruct( ITK_CACHE_LINE_ALIGNMENT, ProbabilityJEMetricGetValueAndDerivativePerThreadStruct, PaddedProbabilityJEMetricGetValueAndDerivativePerThreadStruct );
        itkAlignedTypedef( ITK_CACHE_LINE_ALIGNMENT, PaddedProbabilityJEMetricGetValueAndDerivativePerThreadStruct, AlignedProbabilityJEMetricGetValueAndDerivativePerThreadStruct );
        
        mutable AlignedProbabilityJEMetricGetValueAndDerivativePerThreadStruct *  m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariables;
        mutable ThreadIdType                                                                    m_ProbabilityJEMetricGetValueAndDerivativePerThreadVariablesSize;
        ...
        private:
            ...
            ProbabilityJEMetric( const Self & ); // purposely not implemented
...
#include "itkProbabilityJEMetric.hxx"
#endif

#endif // end #ifndef __itkProbabilityJEMetric_H__

        ...
        NonZeroJacobianIndicesType & nzji ) const
{
    ...
    ::GetSpatialJacobian( const InputPointType & ipp, SpatialJacobianType & sj ) const
    {
        ...
        /** Get Jacobian from right subtransform. */
        const unsigned int subt = vnl_math_min( this->m_NumberOfSubTransforms - 1, static_cast< unsigned int >( vnl_math_max( 0, vnl_math_rnd( ( ipp[ ReducedInputSpaceDimension ] - m_StackOrigin ) / m_StackSpacing ) ) ) );
    ...
    ::GetJacobianOfSpatialJacobian(const InputPointType & ipp, JacobianOfSpatialJacobianType & jsj, NonZeroJacobianIndicesType & nonZeroJacobianIndices ) const
    {
    ...
    void
    StackTransform< TScalarType, NDimensions, VSplineOrder >
    ::GetJacobianOfSpatialJacobian(const InputPointType & ipp, SpatialJacobianType & sj, JacobianOfSpatialJacobianType & jsj, NonZeroJacobianIndicesType & nonZeroJacobianIndices ) const
    {

 ...
 *
 *=========================================================================*/
#ifndef __itkRecursivePermutedBSplineTransform_h
#define __itkRecursivePermutedBSplineTransform_h
...
namespace itk
{
/** \class RecursivePermutedBSplineTransform
...
public:
  ...
  typedef RecursivePermutedBSplineTransform              Self;
  ...
  itkTypeMacro( RecursivePermutedBSplineTransform, AdvancedBSplineDeformableTransform );
...
/** Interpolation kernel type. */
   ...
   * It calls RecursivePermutedBSplineTransformImplementation2::InterpolateTransformPoint
...
protected:
  ...
  RecursivePermutedBSplineTransform();
  virtual ~RecursivePermutedBSplineTransform(){};
...
}; // end class RecursivePermutedBSplineTransform

} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkRecursivePermutedBSplineTransform.hxx"
#endif

#endif /* __itkRecursivePermutedBSplineTransform_h */

...
void
RecursiveBSplineTransform<TScalar, NDimensions, VSplineOrder>
::TransformPointFunctionalRecursiveFunction( OutputPointType2 opp, CoefficientPointerVectorType mu, const OffsetValueType * gridOffsetTable, const double * weights1D, unsigned int D ) const
{
    if( D == 0 ) //END CASE D = 0
    {

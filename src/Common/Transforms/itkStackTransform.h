...
public:
   ...
   * sub transforms. */
    ...
    {
        itkExceptionMacro( << "Spatial Jacobian was not implemented for StackTransform" );
    }
...
//    }
    ...
    {
        itkExceptionMacro( << "JacobianOfSpatialJacobian was not implemented for StackTransform" );
    }
...
//            NonZeroJacobianIndicesType & nonZeroJacobianIndices ) const
//    {
//        itkExceptionMacro( << "JacobianOfSpatialHessian was not implemented for StackTransform" );
//    }

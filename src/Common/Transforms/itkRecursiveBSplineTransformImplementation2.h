 ...
 *
 *=========================================================================*/
#ifndef __itkRecursiveBSplineTransformImplementation2_h
#define __itkRecursiveBSplineTransformImplementation2_h
 ...
 * Note that it might be better to use RecursiveBSplineImplementation.h
 *
...
#endif /* __itkRecursiveBSplineTransformImplementation2_h */

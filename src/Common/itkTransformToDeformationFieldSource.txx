...
/** This code was inspired by ITK code. The original copyright message
 * is stated below: */
/*=========================================================================

  Program:   Insight Segmentation & Registration Toolkit
  Module:    $RCSfile: itkDeformationFieldImageFilter.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef _itkTransformToDeformationFieldSource_txx
#define _itkTransformToDeformationFieldSource_txx
  ...
  int threadId )
{
  ...
  while ( !outIt.IsAtEnd() )
  {
    ...
    transformedPoint = m_Transform->TransformPoint( outputPoint );
  ...
  int threadId )
{
  ...
  transformedPointNeighbour = m_Transform->TransformPoint( outputPointNeighbour );

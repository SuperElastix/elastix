...
namespace Statistics{
  ...
  template< class TMeasurementVector, class TInternalValue >
    ...
    ::GetMeasurementVector( const InstanceIdentifier &id, MeasurementVectorType & mv ) const
  {
    if ( id < this->m_InternalContainerSize )
    {
      //mv = this->m_InternalContainer[ id ];
  ...
  template< class TMeasurementVector, class TInternalValue >
    ...
    const unsigned int &dim, const MeasurementType &value )
  {
    if ( id < this->m_InternalContainerSize )
    {

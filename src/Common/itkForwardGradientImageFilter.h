...
=========================================================================*/
#ifndef __itkForwardGradientImageFilter_h
#define __itkForwardGradientImageFilter_h
...
namespace itk
{
/** \class ForwardGradientImageFilter
...
class ITK_EXPORT ForwardGradientImageFilter :
...
public:
  ...
  typedef ForwardGradientImageFilter Self;
  ...
  itkTypeMacro(ForwardGradientImageFilter, ImageToImageFilter);
  ...
  /** ForwardGradientImageFilter needs a larger input requested region than
   * the output requested region.  As such, ForwardGradientImageFilter needs
...
protected:
  ForwardGradientImageFilter()
    {
      m_UseImageSpacing = true;
    }
  virtual ~ForwardGradientImageFilter() {}
  void PrintSelf(std::ostream& os, Indent indent) const;

  /** ForwardGradientImageFilter can be implemented as a multithreaded filter.
...
private:
  ForwardGradientImageFilter(const Self&); //purposely not implemented
...
#include "itkForwardGradientImageFilter.txx"
#endif

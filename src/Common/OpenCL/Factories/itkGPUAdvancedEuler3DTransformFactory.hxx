...
void
GPUAdvancedEuler3DTransformFactory2< NDimentions >::RegisterOneFactory()
{
  typedef GPUAdvancedEuler3DTransformFactory2< NDimentions > GPUTransformFactoryType;
...
//------------------------------------------------------------------------------
template< typename NDimentions >
GPUAdvancedEuler3DTransformFactory2< NDimentions >::GPUAdvancedEuler3DTransformFactory2()
{
  this->RegisterAll();
}
...
template< typename NDimentions >
void
GPUAdvancedEuler3DTransformFactory2< NDimentions >
::Register3D()
{

...
void
GPUSimilarity2DTransformFactory2< NDimentions >::RegisterOneFactory()
{
  typedef GPUSimilarity2DTransformFactory2< NDimentions > GPUTransformFactoryType;
...
//------------------------------------------------------------------------------
template< typename NDimentions >
GPUSimilarity2DTransformFactory2< NDimentions >::GPUSimilarity2DTransformFactory2()
{
  this->RegisterAll();
}
...
template< typename NDimentions >
void
GPUSimilarity2DTransformFactory2< NDimentions >
::Register2D()
{

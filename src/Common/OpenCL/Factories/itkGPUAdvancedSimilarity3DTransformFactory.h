 ...
 *
 *=========================================================================*/
#ifndef __itkGPUAdvancedSimilarity3DTransformFactory_h
#define __itkGPUAdvancedSimilarity3DTransformFactory_h
...
class GPUAdvancedSimilarity3DTransformFactory2 : public GPUObjectFactoryBase< NDimentions >
{
public:
  ...
  void operator()( void )
  {
    this->RegisterOverride(
      typeid( AdvancedSimilarity3DTransform< TType > ).name(),
      typeid( GPUAdvancedSimilarity3DTransform< TType > ).name(),
      "GPU AdvancedSimilarity3DTransform override", true,
...
private:
  ...
  GPUAdvancedSimilarity3DTransformFactory2( const Self & ); // purposely not implemented
...
#endif /* __itkGPUAdvancedSimilarity3DTransformFactory_h */

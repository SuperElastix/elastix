...
#define OverrideLinearInterpolateImageFunctionTypeMacro( ipt, opt, dm1, dm2, dm3 )                 \
  ...
  GPULinearInterpolateImageFunctionFactory()
  {
    ...
    {
      // TCoordRep = float
      //OverrideLinearInterpolateImageFunctionTypeMacro(unsigned char, float, 1,
      // 2, 3);
      //OverrideLinearInterpolateImageFunctionTypeMacro(char, float, 1, 2, 3);
      //OverrideLinearInterpolateImageFunctionTypeMacro(unsigned short, float,
      // 1, 2, 3);
      OverrideLinearInterpolateImageFunctionTypeMacro( short, float, 1, 2, 3 );
      //OverrideLinearInterpolateImageFunctionTypeMacro(unsigned int, float, 1,
      // 2, 3);
      ...
      // TCoordRep = double
      //OverrideLinearInterpolateImageFunctionTypeMacro(unsigned char, double,
      // 1, 2, 3);
      //OverrideLinearInterpolateImageFunctionTypeMacro(char, double, 1, 2, 3);
      //OverrideLinearInterpolateImageFunctionTypeMacro(unsigned short, double,
      // 1, 2, 3);
      //OverrideLinearInterpolateImageFunctionTypeMacro(short, double, 1, 2, 3);
      //OverrideLinearInterpolateImageFunctionTypeMacro(unsigned int, double, 1,
      // 2, 3);
      ...
      //OverrideLinearInterpolateImageFunctionTypeMacro(double, double, 1, 2,
      // 3);
    }
  }
};

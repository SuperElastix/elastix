...
public:
  ...
  {
    GPUResampleImageFilterFactory::Pointer factory = GPUResampleImageFilterFactory::New();
...
#define OverrideResampleImageFilterTypeMacro(ipt,opt,pt,dm)\
  ...
  GPUResampleImageFilterFactory()
  {
    ...
    {
      // general types
      //OverrideResampleImageFilterTypeMacro(unsigned char, unsigned char, float, 1);
      //OverrideResampleImageFilterTypeMacro(char, char, float, 1);
      //OverrideResampleImageFilterTypeMacro(unsigned short, unsigned short, float, 1);
      OverrideResampleImageFilterTypeMacro(short, short, float, 1);
      //OverrideResampleImageFilterTypeMacro(unsigned int, unsigned int, float, 1);
      ...
      //OverrideResampleImageFilterTypeMacro(unsigned char, unsigned char, float, 2);
      //OverrideResampleImageFilterTypeMacro(char, char, float, 2);
      //OverrideResampleImageFilterTypeMacro(unsigned short, unsigned short, float, 2);
      OverrideResampleImageFilterTypeMacro(short, short, float, 2);
      //OverrideResampleImageFilterTypeMacro(unsigned int, unsigned int, float, 2);
      ...
      //OverrideResampleImageFilterTypeMacro(unsigned char, unsigned char, float, 3);
      //OverrideResampleImageFilterTypeMacro(char, char, float, 3);
      //OverrideResampleImageFilterTypeMacro(unsigned short, unsigned short, float, 3);
      OverrideResampleImageFilterTypeMacro(short, short, float, 3);
      //OverrideResampleImageFilterTypeMacro(unsigned int, unsigned int, float, 3);

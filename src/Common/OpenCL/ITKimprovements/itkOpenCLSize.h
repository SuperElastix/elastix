...
public:
  ...
  OpenCLSize( const Null & ) :
    m_Dim( 0 )
  { this->m_Sizes[ 0 ] = 0; this->m_Sizes[ 1 ] = 0; this->m_Sizes[ 2 ] = 0; }
  ...
  OpenCLSize() :
    m_Dim( 1 )
  { this->m_Sizes[ 0 ] = 1; this->m_Sizes[ 1 ] = 1; this->m_Sizes[ 2 ] = 1; }
  ...
  OpenCLSize( const std::size_t size ) :
    m_Dim( 1 )
  { this->m_Sizes[ 0 ] = size; this->m_Sizes[ 1 ] = 1; this->m_Sizes[ 2 ] = 1; }
  ...
  OpenCLSize( const std::size_t width, const std::size_t height ) :
    m_Dim( 2 )
  { this->m_Sizes[ 0 ] = width; this->m_Sizes[ 1 ] = height; this->m_Sizes[ 2 ] = 1; }
  ...
  OpenCLSize( const std::size_t width, const std::size_t height, const std::size_t depth ) :
    m_Dim( 3 )
  { this->m_Sizes[ 0 ] = width; this->m_Sizes[ 1 ] = height; this->m_Sizes[ 2 ] = depth; }
  ...
  OpenCLSize( const SizeType1D & size ) :
    m_Dim( 1 )
  { this->m_Sizes[ 0 ] = size[ 0 ]; this->m_Sizes[ 1 ] = 1; this->m_Sizes[ 2 ] = 1; }
  ...
  static OpenCLSize GetLocalWorkSize( const OpenCLSize & maxWorkItemSize,

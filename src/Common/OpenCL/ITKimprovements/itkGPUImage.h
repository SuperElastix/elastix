...
#define OverrideImageTypeMacro(pt, dm)        \
  ...
  GPUImageFactory()
  {
    if ( IsGPUAvailable() )
      ...
      OverrideImageTypeMacro(unsigned short, 1);
      OverrideImageTypeMacro(short, 1);
      ...
      OverrideImageTypeMacro(char, 2);
      OverrideImageTypeMacro(unsigned short, 2);
      OverrideImageTypeMacro(short, 2);
      ...
      OverrideImageTypeMacro(char, 3);
      OverrideImageTypeMacro(unsigned short, 3);
      OverrideImageTypeMacro(short, 3);

...
#define OpenCLKernelSetArgMacroH( type ) \
  cl_int SetArg( const cl_uint index, const type value ); \
...
#define  OpenCLKernelSetArgsMacroH( type0, type1, type2, type3, type4 ) \
  OpenCLKernelSetArgMacroH( type0 ) OpenCLKernelSetArgMacroH( type1 ) \
...
#define OpenCLKernelSetArgsMacroCXX( type0, type1, type2, type3, type4 ) \
  OpenCLKernelSetArgMacroCXX( type0 ) OpenCLKernelSetArgMacroCXX( type1 ) \
...
public:
  ...
  OpenCLSize GetBestLocalWorkSizeImage( const std::size_t dimension ) const;
  ...
  size_t GetPreferredWorkSizeMultiple() const;
  ...
  void SetDoubleAsFloat( const bool value ) { this->m_DoubleAsFloat = value; }
  void SetDoubleAsFloatEnable() { this->m_DoubleAsFloat = true; }
  void SetDoubleAsFloatDisable() { this->m_DoubleAsFloat = false; }
  bool GetDoubleAsFloatEnabled() { return this->m_DoubleAsFloat; }
  ...
  */
  ...
  OpenCLEvent LaunchKernel( const OpenCLSize & global_work_size,
  ...
  inline OpenCLEvent operator()() { return this->LaunchKernel(); }

  /** Runs this kernel instance with the argument \a arg1.
   * Returns an event object that can be used to wait for the
   * kernel to finish execution. */
  template< typename T1 >
  inline OpenCLEvent operator()( const T1 & arg1 )
  {
    this->SetArg( 0, arg1 );
  ...
  inline OpenCLEvent operator()( const T1 & arg1, const T2 & arg2 )
  {
    this->SetArg( 0, arg1 );
    this->SetArg( 1, arg2 );
    return this->LaunchKernel();

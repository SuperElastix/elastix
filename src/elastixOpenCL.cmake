  ...
  macro(write_gpu_kernels GPUKernels GPU_SRC GROUP_NAME)
    foreach(GPUKernel ${GPUKernels})
        ...
        if(${KernelFileExtension} STREQUAL ".clh")
            write_gpu_kernel_to_file(${GPUKernel} ${KernelFileName} ${KernelFileName}HeaderKernel "${KernelFileName}HeaderKernel.cxx" ${GPU_SRC} ${GROUP_NAME})
        else()
            write_gpu_kernel_to_file(${GPUKernel} ${KernelFileName} ${KernelFileName}Kernel "${KernelFileName}Kernel.cxx" ${GPU_SRC} ${GROUP_NAME})
        endif()
    endforeach(GPUKernel)
  endmacro(write_gpu_kernels)

endif(ELASTIX_USE_OPENCL)

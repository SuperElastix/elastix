...
namespace elastix
{
  ...
  template <class TElastix >
    ...
    public
          itk::MaximizingFirstPrincipalComponentMetric<
  ...
  public:
    ...
    typedef itk::MaximizingFirstPrincipalComponentMetric<
      typename MetricBase<TElastix>::FixedImageType,
    ...
    itkTypeMacro( MaximizingFirstPrincipalComponentMetric, itk::MaximizingFirstPrincipalComponentMetric );

    /** Name of this class.
     * Use this name in the parameter file to select this specific metric. \n
     * example: <tt>(Metric "MaximizingFirstPrincipalComponentMetric")</tt>\n
     */
    elxClassNameMacro( "MaximizingFirstPrincipalComponentMetric" );
...
#include "elxMaximizingFirstPrincipalComponentMetric.hxx"
#endif

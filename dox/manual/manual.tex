...
isotropically scaled. The rotation matrix is parameterised by an
angle in 2D, and by a so-called ``versor'' in 3D. The parameter
vector $\vmu$ consists of the angle/versor, the translation
vector, and the isotropic scaling factor. In 2D, this gives a
vector of length 4. In 3D, this gives a vector of length 7. There
are few cases when you need this transform.

...
\Biggl[ \D{T_{\vmu,k}}{x_i}(\vxt) &= \left( \D{T_{1,k}}{\vx}(\vy)
\right)^T \D{\vT_0}{x_i}(\vxt) =  \left(\D{\vT_0}{x_i}(\vxt)
\right)^T \D{T_{1,k}}{\vx}(\vy) \qquad \mathrm{(Stefan)} \Biggr]
...
\vT_1(\bm{y}). \\
\Biggl[ \Dd{T_{\vmu,k}}{x_i}{x_j}(\vxt) &= \left(
\D{T_{1,k}}{\vx}(\vy) \right)^T \Dd{\vT_0}{x_i}{x_j}(\vxt) +
\left(\D{\vT_0}{x_i}(\vxt) \right)^T
\Dd{T_{1,k}}{\vx}{\vx^T}(\bm{y}) \D{\vT_0}{x_j}(\vxt) \qquad
\mathrm{(Stefan)} \Biggr]
...
\D{}{x_j} \vT_1(\bm{y}). \\
\Biggl[ \D{}{\vmu} \Dd{T_{mu,k}}{x_i}{x_j}(\vxt) &=
\Dd{T_{1,k}}{\vmu}{\vx^T}(\vy) \Dd{\vT_0}{x_i}{x_j}(\vxt) +
\left(\D{\vT_0}{x_i}(\vxt) \right)^T \left(\D{}{\vmu}
\Dd{T_{1,k}}{\vx}{\vx^T}(\bm{y})\right) \D{\vT_0}{x_j}(\vxt) \qquad
\mathrm{(Stefan)} \Biggr]
\end{align}

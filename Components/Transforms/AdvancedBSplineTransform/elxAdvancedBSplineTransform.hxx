...
template <class TElastix>
void
AdvancedBSplineTransform<TElastix>::WriteToFile(const ParametersType & param) const
{
...
template <class TElastix>
void
AdvancedBSplineTransform<TElastix>::CreateTransformParametersMap(const ParametersType & param,

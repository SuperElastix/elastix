...
template <class TElastix>
void
BSplineStackTransform<TElastix>::WriteToFile(const ParametersType & param) const
{
  ...
  xout["transpar"] << "(NumberOfSubTransforms " << this->m_BSplineStackTransform->GetNumberOfSubTransforms() << ")"
                   << std::endl;

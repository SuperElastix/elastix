...
class StackTransformBendingEnergyPenalty
  : public itk::StackTransformBendingEnergyPenaltyTerm<typename MetricBase<TElastix>::FixedImageType, double>
  , public MetricBase<TElastix>
{
public:
  /** Standard ITK-stuff. */
  typedef StackTransformBendingEnergyPenalty Self;
  typedef itk::StackTransformBendingEnergyPenaltyTerm<typename MetricBase<TElastix>::FixedImageType, double>
                                        Superclass1;

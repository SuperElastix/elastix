 ...
 * Example:
 * \code
 * (ImpactModelsPath "/Data/Models/TS/M850_8_Layers.pt /Data/Models/MIND/R1D2.pt")
 * (ImpactDimension "3 3")
 * (ImpactNumberOfChannels "1 1")
 * (ImpactPatchSize "0*0*0 0*0*0")
 ...
 * For instance:
 * \code
 * (ImpactPatchSize "5*5*5 5*5*5" "3*3*3 3*3*3" "1*1*1 1*1*1")
 * \endcode
